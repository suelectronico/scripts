...
sudo parted -s -a optimal $DEVICE mkpart primary ext4 300MB 30%

# Crear la partición home del 30%
sudo parted -s -a optimal $DEVICE mkpart primary ext4 30% 60%

# Crear la partición almacén con el resto del espacio
sudo parted -s -a optimal $DEVICE mkpart primary ext4 60% 100%
